...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-132/MyRxSDK.xcframework.zip",
            checksum: "df597844b369a72357b66d60e0fdf76efe72b4512290ca3bcd9ee8c6ecd6ed2f"
        )
    ]
)
