...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.9.0-370/MyRxSDK.xcframework.zip",
            checksum: "57cb44041571fb07d0b46b0e97ed11c867867940a31285017962a361726c66fd"
        )
    ]
)
