...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-554/MyRxSDK.xcframework.zip",
            checksum: "ae6ecb26ad4e3f48bf07371e42d815541f92d9c5eac3c1a4945d2bb9c150d21e"
        )
    ]
)
