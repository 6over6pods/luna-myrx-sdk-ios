...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.2.3/MyRxSDK.xcframework.zip",
            checksum: "4f3d767495b2c31562bb99299b55340580cb32ca8ae7b0b0f51545fe31250d4e"
        )
    ]
)
