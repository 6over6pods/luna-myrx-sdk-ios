...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.15.0-467/MyRxSDK.xcframework.zip",
            checksum: "69e44b0b7f711b1a657ef37a15162a45b76eb9b60c38032099b29f179829dff0"
        )
    ]
)
