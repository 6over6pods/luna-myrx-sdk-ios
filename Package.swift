...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-126/MyRxSDK.xcframework.zip",
            checksum: "b17a40258510205a4e50aa93a638a12aa987849ef32864864f0889aa8450681f"
        )
    ]
)
