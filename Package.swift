...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.3-583/MyRxSDK.xcframework.zip",
            checksum: "cb7e2e8c7bf32f5154e6e57a362fc2c3fc6c4ef90d67ff82ce48655d67602ca4"
        )
    ]
)
