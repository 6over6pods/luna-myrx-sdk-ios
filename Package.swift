...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.11.0-414/MyRxSDK.xcframework.zip",
            checksum: "c53d99772940e185b3f12dec7fbc9071134df646feab6c44c7102d75ef998a2b"
        )
    ]
)
