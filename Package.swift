...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-572/MyRxSDK.xcframework.zip",
            checksum: "cc07308047014f87215783d2b9f1c4abba6b9cc62d0787f48ce91ee500aad6c2"
        )
    ]
)
