...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.3-600/MyRxSDK.xcframework.zip",
            checksum: "d21602c1e2213d0f6f70c73ed4bf2331dd54b6efe6e94240e4f758d56a31a48b"
        )
    ]
)
