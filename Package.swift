...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.13.0-449/MyRxSDK.xcframework.zip",
            checksum: "5db5d509689cc142662fd358e905069fc2316fe83517d6dc87be1d6ed365ec92"
        )
    ]
)
