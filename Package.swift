...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-555/MyRxSDK.xcframework.zip",
            checksum: "5c52627fa39ec2345a37f0aeaa3b07aa2684e4f881edb4291c00c3bc84dca5b4"
        )
    ]
)
