...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-517/MyRxSDK.xcframework.zip",
            checksum: "d155ea03c5b93801cb00aa8c06ec93a8e2f8b4cb9c369ee3965927d1787ec603"
        )
    ]
)
