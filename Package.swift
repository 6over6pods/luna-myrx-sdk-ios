...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.4-297/MyRxSDK.xcframework.zip",
            checksum: "b60b78f6c94c10c77bb0ce1c5841560cfd6474895785f457902e10c37ca9e584"
        )
    ]
)
