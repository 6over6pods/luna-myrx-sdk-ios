...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-112/MyRxSDK.xcframework.zip",
            checksum: "5654779a98f2029efff4382fc8f99922f92b80dedbd25739e1657418de77f60f"
        )
    ]
)
