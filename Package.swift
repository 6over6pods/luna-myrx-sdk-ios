...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.11.0-424/MyRxSDK.xcframework.zip",
            checksum: "239c4c2d872fe4114b813993b6ba762381ea5ccd8bcc5fec474ece7c18af4b8c"
        )
    ]
)
