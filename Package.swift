...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.1-291/MyRxSDK.xcframework.zip",
            checksum: "9ede0de221f8e9e6fe1e41a2edffd5de62ab98ee21f32d02a70f5bec995bcbcf"
        )
    ]
)
