...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.15.0-471/MyRxSDK.xcframework.zip",
            checksum: "5b206ef87b8820150f47e6f425c2a76734eef5e74e6f5594272d6d6f0a2cf5e8"
        )
    ]
)
