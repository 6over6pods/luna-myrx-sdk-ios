...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-116/MyRxSDK.xcframework.zip",
            checksum: "e160d4a6862a079aa0b5165dbb234852f3e03ff7770e4ba9245e61a2666abcdc"
        )
    ]
)
