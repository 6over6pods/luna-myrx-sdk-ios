...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.0-218/MyRxSDK.xcframework.zip",
            checksum: "4a35ee1eccaeb442ebcaecccbf1d5d548dfd19777550234faf20bb0b9fff68fe"
        )
    ]
)
