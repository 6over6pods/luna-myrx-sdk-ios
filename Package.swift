...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.1-222/MyRxSDK.xcframework.zip",
            checksum: "8bbb927acffbb636d9ba2fe1c50e00b2c07beecf6edd5f4daa223a95ececfaa5"
        )
    ]
)
