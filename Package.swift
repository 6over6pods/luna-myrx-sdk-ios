...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-92/MyRxSDK.xcframework.zip",
            checksum: "3f56863be24c0ccd47fad62ad33234596d572bcac89eaee92f5fbd79561bb733"
        )
    ]
)
