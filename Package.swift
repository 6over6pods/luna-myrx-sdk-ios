...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.10.0-387/MyRxSDK.xcframework.zip",
            checksum: "afa6d0c3cbb183d139bcc92736b231d5cf152b832dce8cd38eacd2677fd407ae"
        )
    ]
)
