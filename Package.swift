...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-152/MyRxSDK.xcframework.zip",
            checksum: "fa8e7de03fae4318a98b9b29bbcbfafc3162b43d5734ecb22e99c9491a299572"
        )
    ]
)
