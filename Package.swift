...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-530/MyRxSDK.xcframework.zip",
            checksum: "02f87c653da450fd5675427b0992a83ae65ac5695eaea90d33d313ca363540d9"
        )
    ]
)
