...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-534/MyRxSDK.xcframework.zip",
            checksum: "5a4f187bdace8193658a8eb9f3b4e6d4bde246a976b3a318c3dc601a794ec9cb"
        )
    ]
)
