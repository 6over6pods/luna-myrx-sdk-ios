...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.10.2-394/MyRxSDK.xcframework.zip",
            checksum: "d55cc48f9f0a27a7bd2404ee829a8c34bd6ff9bad5a6056871f2fb7dd14caeaa"
        )
    ]
)
