...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.4-301/MyRxSDK.xcframework.zip",
            checksum: "9f23af86b83723f560a4bb027d9b729951f95890bc2ba849897d1bd5874e3aeb"
        )
    ]
)
