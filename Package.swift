...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-569/MyRxSDK.xcframework.zip",
            checksum: "fc56e467907ca415535c0e3aa1c835c92b7495e7c11cef006eec7efc7164acdf"
        )
    ]
)
