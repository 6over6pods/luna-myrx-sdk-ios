...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-148/MyRxSDK.xcframework.zip",
            checksum: "660586522c551b1bafda673fa5597d43f5eb249944badab57a0bfdbeeb50f057"
        )
    ]
)
