...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.0-214/MyRxSDK.xcframework.zip",
            checksum: "e496f1fbff6ee882a43d14f77cc970e2c810b7a8b1688a488353a3febb799f9d"
        )
    ]
)
