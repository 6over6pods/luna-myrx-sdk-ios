...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-548/MyRxSDK.xcframework.zip",
            checksum: "a6665a732617259496aef9460942a607008f1b735787873b2167e4188b8d13bc"
        )
    ]
)
