...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.9.1-383/MyRxSDK.xcframework.zip",
            checksum: "d96ea5532d7f6c1c44a4512412cd8d743372dbe70055567e626d9359b11e9e69"
        )
    ]
)
