...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-558/MyRxSDK.xcframework.zip",
            checksum: "fa49cd9acc3e5b9fa91fcc68cd1b277f2b24c58a4cfae409aefd1f2c586b59af"
        )
    ]
)
