...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-123/MyRxSDK.xcframework.zip",
            checksum: "e8a8d9d80527b7fd2dca6647b4c1c1682499d217d75605593ed04bb1bfb51262"
        )
    ]
)
