...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-537/MyRxSDK.xcframework.zip",
            checksum: "b27607babf838afc242c258171321cc1f742494c07acea6d1abc041beb401618"
        )
    ]
)
