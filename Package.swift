...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/2.0.0/MyRxSDK.xcframework.zip",
            checksum: "77f96843f9cb96f2a8b6d1b1892a99717b543aa099354a2039c1980b137be449"
        )
    ]
)
