...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.12.0-433/MyRxSDK.xcframework.zip",
            checksum: "343d4d9cec1c38494bc9aebfd8cfc4703b640dbe28545b0bcf2be98e31aa5aa1"
        )
    ]
)
