...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.1-507/MyRxSDK.xcframework.zip",
            checksum: "98751277a3209a078619e54380e7e6cb83ff6d849d2de7932115f43392a98695"
        )
    ]
)
