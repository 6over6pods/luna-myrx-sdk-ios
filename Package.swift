...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.2-283/MyRxSDK.xcframework.zip",
            checksum: "9b2508bee37ba86709fceebf036680260dd5eaa078644206c456cfe29ed12494"
        )
    ]
)
