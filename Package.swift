...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-563/MyRxSDK.xcframework.zip",
            checksum: "eb4590a9a37c29068daea844197e4566d4cba20adfdf4c568a293e26de7bc9f5"
        )
    ]
)
