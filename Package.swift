...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/4.2.0/MyRxSDK.xcframework.zip",
            checksum: "08ee26319acc9d6546c9a9fb5512c08c11271ce0a42719e470c049f36753fa3c"
        )
    ]
)
