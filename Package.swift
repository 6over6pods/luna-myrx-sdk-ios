...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.7.0-209/MyRxSDK.xcframework.zip",
            checksum: "9f886be97f0c2773655e92b78d6ead6d7785d59d247afee060dc7d8c07d42593"
        )
    ]
)
