...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-108/MyRxSDK.xcframework.zip",
            checksum: "f44ebaefe0e6aa813be00311cb7400cedfcc99a8daea1bb60fe088366a8638c2"
        )
    ]
)
