...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.2.7/MyRxSDK.xcframework.zip",
            checksum: "f79acfbdf524571e314bd763d4090a45f2ae91a0c3a4fd2e123eb84d4c97b755"
        )
    ]
)
