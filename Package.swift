...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-145/MyRxSDK.xcframework.zip",
            checksum: "a4ea9ffbcfe56d5529372316147d36af0d8c2c331bf54681181691d0ed34240f"
        )
    ]
)
