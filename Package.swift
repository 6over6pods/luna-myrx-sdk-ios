...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.1-499/MyRxSDK.xcframework.zip",
            checksum: "97a2096e7d5a7938490b25a2b52b3c2bc1c673a770cf49b3b6301e9c2ae569c4"
        )
    ]
)
