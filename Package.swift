...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.10.0-411/MyRxSDK.xcframework.zip",
            checksum: "1d94dca1234f035d472653ba503c993d1b5b19da02246db0c601e5a849253eb1"
        )
    ]
)
