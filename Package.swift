...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-102/MyRxSDK.xcframework.zip",
            checksum: "a4ccfc4a58b8267ed5ba6ec44c98ac2bf3d5b35c0a116ccafa9c3e5a1303f2d1"
        )
    ]
)
