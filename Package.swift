...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.0/MyRxSDK.xcframework.zip",
            checksum: "2daec10967205fa45830211a507aefb506773e6a315223818fbdf2421a3b96a6"
        )
    ]
)
