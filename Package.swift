...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.9.1-375/MyRxSDK.xcframework.zip",
            checksum: "fcb24bf276a38ee9875e3fa64c5e360fd5185855ee0b9eb1f58d0a857c45445b"
        )
    ]
)
