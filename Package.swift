...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/1.0.0/MyRxSDK.xcframework.zip",
            checksum: "a598be2701f42fadcbcd11cd6b76118bb33c798a485b304ab230bb698c9d1531"
        )
    ]
)
