...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.8.0-366/MyRxSDK.xcframework.zip",
            checksum: "b9c08cacdab35ac990642fd4c5dc4c21e8369825a0b12ffe08c4a1cda6b224cb"
        )
    ]
)
