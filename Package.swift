...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-142/MyRxSDK.xcframework.zip",
            checksum: "dc8b773805ed48c4d074602ae79dba71e84bf55a6a9d3dbd14cadd28aea1499b"
        )
    ]
)
