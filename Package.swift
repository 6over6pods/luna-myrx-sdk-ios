...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.0-489/MyRxSDK.xcframework.zip",
            checksum: "e021a9774a9ee1bd9db23e20465b17eb002203aab4a49ebdd215c0d1ac8a4de2"
        )
    ]
)
