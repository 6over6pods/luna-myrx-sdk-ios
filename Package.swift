...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-545/MyRxSDK.xcframework.zip",
            checksum: "bebc8cd5207bf4af13aa51260728fe27a256d87ad272e4c24056ffe078904281"
        )
    ]
)
