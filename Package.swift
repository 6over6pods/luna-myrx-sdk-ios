...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-538/MyRxSDK.xcframework.zip",
            checksum: "561a5888ec1db9f6d50aaa6a454666b0873f82399324927c768d2b3c64c53232"
        )
    ]
)
