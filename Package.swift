...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-191/MyRxSDK.xcframework.zip",
            checksum: "5b9e5ed2701a1c9213b7c4ee78c2aea3e6f3be973a5f7feb466d54dd7d01bb84"
        )
    ]
)
