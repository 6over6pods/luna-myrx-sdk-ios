...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.2.6/MyRxSDK.xcframework.zip",
            checksum: "6091a71dd845c52b367be31612b990c408bffe24848e157af436c4f8b3df6d99"
        )
    ]
)
