...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.11.0-421/MyRxSDK.xcframework.zip",
            checksum: "be3f5d370892892186ef308a95a2ff21ad9c1980ce5e8a4900a339f4c31baf90"
        )
    ]
)
