...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.8.0-362/MyRxSDK.xcframework.zip",
            checksum: "6f328c043ce4252f5e149ccbbc55c93f705733cb2eba849e60c557381e77ed94"
        )
    ]
)
