...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.2.2/MyRxSDK.xcframework.zip",
            checksum: "ff5be868cedea823108689d3c756b01b664303dd0f91da33031743f204b8bfd9"
        )
    ]
)
