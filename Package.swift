...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-575/MyRxSDK.xcframework.zip",
            checksum: "4f07cf4149b7ff5b5f595927b158fe39a15955f3916da5b5d56db3bc1964aba9"
        )
    ]
)
