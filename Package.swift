...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.2-514/MyRxSDK.xcframework.zip",
            checksum: "31eed020517ce105f42de374dac0473cc3c9b84d64be77af2eb996fbf41a0c49"
        )
    ]
)
