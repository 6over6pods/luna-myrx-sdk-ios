...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.12.0-429/MyRxSDK.xcframework.zip",
            checksum: "b15004a14c4e00bebe50009d915c4a516728d04fb68d2d568a3a2ef8f822c27d"
        )
    ]
)
