...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.5-603/MyRxSDK.xcframework.zip",
            checksum: "718fce9f375ca99a64856eb42c491266c2e60ec02604d53cef4a7defee6d3b9e"
        )
    ]
)
