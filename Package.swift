...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.0-483/MyRxSDK.xcframework.zip",
            checksum: "746d29104d74f997730c8e548067bfefe07258b47a03e1b3d9de854287d3b32b"
        )
    ]
)
