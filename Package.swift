...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.10.0-400/MyRxSDK.xcframework.zip",
            checksum: "65bee884cc975797f32efb5d7c3abe2e414c9cc0d05234720d9252abaebc33fc"
        )
    ]
)
