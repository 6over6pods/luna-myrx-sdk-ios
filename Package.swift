...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.4.1-105/MyRxSDK.xcframework.zip",
            checksum: "06d33efcb30fd8c787385518fb10e101719276bacce4e1b5e761abebeb8432f6"
        )
    ]
)
