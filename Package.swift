...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.16.3-594/MyRxSDK.xcframework.zip",
            checksum: "4bb3917ddde0deef840c977199f61b42c95bb848a47da028f6f85466b34a1987"
        )
    ]
)
