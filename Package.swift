...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MyRxSDK",
            url: "https://glasseson.jfrog.io/artifactory/luna-myrx-sdk-ios-local/5.6.0/MyRxSDK.xcframework.zip",
            checksum: "d28cecae288b08c2d0f13644f9d4f7b17b898b0be549010ef67a46db036c9222"
        )
    ]
)
